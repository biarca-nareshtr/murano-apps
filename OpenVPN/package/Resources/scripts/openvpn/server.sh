#!/bin/bash -x
# This file add a bridge interface to instance. Create a *new* directory and prepare it to be used as a (CA) key management directory
...
# Modifying server configaration file with required infomation
